...
export const managers = [
    ...
    //   "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
         ...
         image: "/managers/bump.png", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
  ...
  {//6
    ...
    //   "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
    //   "location": "Brooklyn", // (optional)
      "bio": "Hi I'm ''Doctor'' Blake - and by <i>doctor</i>, I mean the guy who cracks your back, sucks your dick, and gives your child my lollipop. When I'm not handing out fake medical advice, I enjoy sucking Joe's microscopic penis. <p><h3 class=\"svelte-106z4mu\">NFL League Awards</h3><p><div class="gallery"><figure><img src="/awards/champion.png" alt=""><figcaption>ball fonlding, 2012</figcaption></figure><figure><img src="/awards/champion.png" alt=""><figcaption>ball fondling, 2013</figcaption></figure><figure><img src="/awards/champion.png" alt=""><figcaption>best reach around, 2014</figcaption></figure><figure><img src="/awards/champion.png" alt=""><figcaption>best penis tuck, 2019</figcaption></figure></div><style>.gallery{display:flex;flex-wrap:nowrap;overflow-x:auto;gap:1rem;padding:.5rem 0}.gallery figure{flex:0 0 auto;margin:0;text-align:center}.gallery img{max-width:100px;height:auto;display:block;margin:0 auto}.gallery figcaption{font-size:.8rem;margin-top:.25rem}</style></p><p>League Champion: 4x(2012, 2013, 2014, 2019)</p><p><img src=\"/awards/second.png\"></p><p>Second Place: 2018</p><p><img src=\"/awards/generic.png\"></p><p>League Scoring Leader: 2012</p><p><img src=\"/awards/sacko.png\"></p><p>The Sacko (last place): 2023</p><p><img src=\"/awards/toilet.png\"></p><p>The Sucko (lowest scoring team): 2017</p>",
