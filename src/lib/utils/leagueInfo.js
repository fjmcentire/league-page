...
export const managers = [
    ...
    //   "location": "Brooklyn", // (optional)
       "bio": "Until Zac tells me something else to put for his bio, I'll just say he's a whiny bitch every season.<hr><p><b>NFL League Awards</b></p><img src=\"/awards/champion.png\"<p>League Champion: 2x (2015, 2020)</p><p>Second Place: 0</p><p>Third Place: 2x (2016, 2024)</p><p>Regular Season Champ: 0</p><p>League Scoring Leader: 3x (2015, 2017, 2020)</p>  <p>The Sacko (last place): 0</p><p>The Sucko (worst scoring team): 0</p><hr>",
  ...
  {//6
    ...
    //   "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
    //   "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "philosophy": "Wine em, dine em and 69 em. Also fuck blake",
      "tradingScale": 8, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {//7
